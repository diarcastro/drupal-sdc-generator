  ...
  return (
    <div className="relative">
      <input
        ...
        className="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-white rounded-md border border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-olive-drab focus:outline-none focus:ring-0 focus:border-olive-drab peer"
        placeholder=" "
      />
      <label
        htmlFor={id}
